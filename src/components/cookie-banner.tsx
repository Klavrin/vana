...
const CookieBanner = () => {
  const [isHidden, setIsHidden] = useState(
    Boolean(sessionStorage.getItem('simulate-cookie-banner'))
  )

  const handleDeny = () => {
    setIsHidden(true)
    sessionStorage.setItem('simulate-cookie-banner', 'true')
  }
      ...
      {!isHidden && (
        <div className="w-[62vw] h-[4.2vw] backdrop-blur-md border-[0.078vw] border-white fixed bottom-[1.5vw] right-[2.5vw] z-50 p-[0.8vw] rounded-tl-[1vw] rounded-br-[1vw] flex justify-between gap-[6vw]">
          <p className="text-[0.95vw] font-light leading-[1.3vw]">
            We use third-party cookies in order to improve your site experience and
            deliver personalized content. By using VANA®, you agree to our{' '}
          ...
          <div className="flex gap-[0.8vw]">
            <CustomButton onClick={handleDeny} styles="px-[2.92vw] border-white/50">
              DENY
            </CustomButton>
